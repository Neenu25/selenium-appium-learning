	...
	public class AccountDeletion {
	    ...
	    private void performLogin() {
	        try {
	            ...
	            emailField.click();
	            emailField.clear();
	            emailField.sendKeys("testr@mailinator.com");
	    ...
	    private void deleteAccount() {
	        try {
	            ...
	            WebElement confirmDeleteButton = wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.accessibilityId("削除する")));
	    ...
	    private void restartApp() {
	        try {
	            ...
	            loginAndDeleteAccountTest(); // Retry the test
	        } catch (Exception e) {
	            e.printStackTrace();
	        }
	    }
